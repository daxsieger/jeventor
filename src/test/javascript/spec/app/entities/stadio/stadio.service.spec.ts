...
describe('Service Tests', () => {
    describe('Stadio Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(StadioService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/stadios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Stadio', () => {
                service.create(new Stadio(null)).subscribe(received => {
            ...
            it('should update a Stadio', () => {
                service.update(new Stadio(123)).subscribe(received => {
