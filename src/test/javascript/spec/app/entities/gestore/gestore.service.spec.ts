...
describe('Service Tests', () => {
    describe('Gestore Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(GestoreService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/gestores';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Gestore', () => {
                service.create(new Gestore(null)).subscribe(received => {
            ...
            it('should update a Gestore', () => {
                service.update(new Gestore(123)).subscribe(received => {
