...
import { ProduttoreComponent } from 'app/entities/produttore/produttore.component';
...
describe('Component Tests', () => {
    describe('Produttore Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.produttores[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
