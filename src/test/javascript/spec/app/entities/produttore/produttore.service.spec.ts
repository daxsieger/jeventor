...
describe('Service Tests', () => {
    describe('Produttore Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProduttoreService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/produttores';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Produttore', () => {
                service.create(new Produttore(null)).subscribe(received => {
            ...
            it('should update a Produttore', () => {
                service.update(new Produttore(123)).subscribe(received => {
