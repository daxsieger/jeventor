...
describe('Service Tests', () => {
    describe('Transizioni Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TransizioniService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/transizionis';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Transizioni', () => {
                service.create(new Transizioni(null)).subscribe(received => {
            ...
            it('should update a Transizioni', () => {
                service.update(new Transizioni(123)).subscribe(received => {
            ...
            it('should return a Transizioni', () => {
