...
describe('Service Tests', () => {
    describe('Assistito Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AssistitoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/assistitos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Assistito', () => {
                service.create(new Assistito(null)).subscribe(received => {
            ...
            it('should update a Assistito', () => {
                service.update(new Assistito(123)).subscribe(received => {
