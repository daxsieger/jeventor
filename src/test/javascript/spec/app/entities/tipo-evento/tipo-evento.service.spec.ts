    ...
    describe('TipoEvento Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tipo-eventos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TipoEvento', () => {
                service.create(new TipoEvento(null)).subscribe(received => {
            ...
            it('should update a TipoEvento', () => {
                service.update(new TipoEvento(123)).subscribe(received => {
