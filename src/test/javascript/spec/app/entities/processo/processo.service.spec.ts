    ...
    describe('Processo Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/processos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Processo', () => {
                service.create(new Processo(null)).subscribe(received => {
            ...
            it('should update a Processo', () => {
                service.update(new Processo(123)).subscribe(received => {
