...
type EntityResponseType = HttpResponse<IAssistito>;
type EntityArrayResponseType = HttpResponse<IAssistito[]>;

@Injectable({ providedIn: 'root' })
export class AssistitoService {
    private resourceUrl = SERVER_API_URL + 'api/assistitos';
    ...
    update(assistito: IAssistito): Observable<EntityResponseType> {
        return this.http.put<IAssistito>(this.resourceUrl, assistito, { observe: 'response' });
    }
