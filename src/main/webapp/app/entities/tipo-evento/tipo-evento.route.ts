...
export class TipoEventoResolve implements Resolve<ITipoEvento> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).map((tipoEvento: HttpResponse<TipoEvento>) => tipoEvento.body);
        }
        return Observable.of(new TipoEvento());
    }
}
...
export const tipoEventoRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'jeventorApp.tipoEvento.home.title'
        },
